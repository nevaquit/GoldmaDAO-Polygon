            ...
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric wsoprice">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "wsGMA = sGMA * index\n\nThe price of wsGMA is equal to the price of GMA multiplied by the current index"
                    }
                  />
                </Typography>
              ...
              <Box className="metric index">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of sGMA accumulated since the beginning of staking. Basically, how much sGMA one would have if they staked and held a single GMA from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " sGMA" : <Skeleton type="text" />}
                </Typography>
              </Box>
            </Box>
          </Paper>
