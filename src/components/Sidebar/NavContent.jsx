...
import { ReactComponent as GOLDMAIcon } from "../../assets/icons/gold-nav-header1.svg";
import { ReactComponent as BetaIcon } from "../../assets/icons/Beta1.svg";
      ...
      <Box className="dapp-sidebar-inner" display="flex" justifyContent="space-between" flexDirection="column">
        <div className="dapp-menu-top">
          <Box className="branding-header">
            <Link href="https://goldmadao.com" target="_blank">
            
              <BetaIcon
                color="primary"
                component={BetaIcon}
                viewBox="30 10 150 200"
                style={{ minWdth: "151px", minHeight: "50px", width: "100px", position: "absolute" }}
              />
              <GOLDMAIcon
                color="primary"
                component={GOLDMAIcon}
                viewBox="30 10 100 90"
                style={{ minWdth: "151px", minHeight: "165px", width: "151px" }}
              />
              <div className="wallet-link f-32">GOLDMA DAO</div>
            </Link>
            {address && (
