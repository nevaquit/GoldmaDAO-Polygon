...
interface IsGMA {
    function rebase( uint256 gmaProfit_, uint epoch_) external returns (uint256);
...
contract GoldmaStaking is Ownable {
    ...
    /**
        @notice stake GMA to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sGMA from warmup
    ...
    /**
        @notice forfeit sGMA in warmup and retrieve GMA
     */
    ...
    /**
        @notice returns the sGMA index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract GMA holdings, including bonuses provided
        @return uint
     */
